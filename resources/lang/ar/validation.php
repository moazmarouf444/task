...
return [
    ...
    'custom'               => [
        'attribute-name' => [
            ...
            'is_blocked.required'     => 'حقل الحاله مطلوب',
        ],
    ],
    ...
    'attributes'           => [
        ...
        'title.ar' => 'حقل العنوان باللغه العربيه',
        'title.en' => 'حقل العنوان باللغه الانجليزيه',
        'description.ar' => 'حقل الوصف باللغه العربيه',
        'description.en' => 'حقل الوصف باللغه الانجليزيه',
        ...
        'privacy_en'                 => 'سياسه الخصوصيه بالانجليزيه ',
        'title_en'                 => 'العنوان بالانجليزيه',
        'reason_id'                => 'السبب',
        'code'                     => 'كود التفعيل',
        ...
        'about_ar'                => 'من نحن باللغه العربيه ',
        'about_en'                     => 'من نحن باللغه الانجليزيه',
        'vision_ar'              => 'رؤيتنا باللغه العربيه',
        'vision_en'                => 'رؤيتنا باللغه الانجليزيه',
        'message_ar'             => 'رسالتنا باللغه العربيه',
        'message_en'              => 'رسالتنا باللغه الانجليزيه',
        'our_motto_ar'               => 'شعارنا باللغه العربيه',
        'our_motto_en'                     => 'شعارنا باللغه الانجليزيه ',

        'commerical_number_expire'                         => 'تاريخ انتهاء صلاحيه السجل التجاري',
        'commerce_subscription_number_expire'                         => 'تاريخ انتهاء رقم اشتراك الغرفه التجاريه',
        'profession_number_expire'                         => 'تاريخ انتهاء رقم رخصه مزاوله المهنه الهندسيه للمنشاه',
        'university_certificate'                         => 'صوره الشهاده الجامعيه مطلوبه ',
    ],
];
