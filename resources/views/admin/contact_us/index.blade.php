    ...
    <!--  BEGIN CONTENT AREA  -->
        <div class="layout-px-spacing">
            ...
            <div class="seperator-header">
                <a  href="" data-route="{{route('admin.inbox.destroy_selected')}}" class="btn btn-danger mb-2 delete_all_button">
                    حذف المحدد
                        ...
                        <div class="widget-content widget-content-area table-responsive">
                            <table id="style-3" class="table style-3  table-hover table-bordered table-striped table-checkable table-highlight-head mb-4">
                                ...
                                @foreach ($messages as $message)
                                    <tr class="delete_row checkbox-column" id="row-{{$message->id}}">
                                        <td class="text-center " data-id="{{ $message->id }}">
                                            <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                <input type="checkbox" class="new-control-input todochkbox checkSingle"  id="{{ $message->id }}">
                                        ...
                                        <td class="text-center product-action">
                                            <ul class="table-controls">
                                                <li>
                                                    <a href="{{ route('admin.inbox.show', ['id' => $message->id]) }}"
                                                       title="عرض">
                                                ...
                                                <li>
                                                        <span class="delete-row bs-tooltip" data-url="{{ url('admin/inbox/' . $message->id) }}"
                                                              data-id="{{ $message->id }}">
