...
@section('page_name', 'تعديل صلاحية')
...
@section('content')
    ...
    <div class="layout-px-spacing">
        <div class="layout-px-spacing">
            ...
            <!-- START: Content-->
            <form class="store" action="{{ route('admin.permissions.update', $role) }}" method="POST" >
            @csrf
            @method('PUT')
                                            ...
                                            @foreach($permission['childrens'] as $child)
                                                <li class="d-flex justify-content-between align-items-center py-25">
                                                    <span class="vs-checkbox-con vs-checkbox-primary">
                                                        <input name="permissions[]" value="{{ $child }}" class="checkbox-input checkk"
