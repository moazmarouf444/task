...
@section('style')
    ...
    <style>
        ...
        .statbox nav .relative{

            display: inline-flex;
            gap: 5px
        }
        .statbox nav .relative .relative{
        ...
        .statbox nav > div:first-child{display: none !important;}
...
@section('content')
    ...
    <div class="layout-px-spacing">
        <div class="seperator-header">
                <a href="{{route('admin.permissions.create')}}" class="btn btn-outline-primary mb-2">اضافه</a>
                <a  data-route="{{route('admin.permissions.destroy_selected')}}" class="btn btn-danger mb-2 delete_all_button">
                    حذف المحدد
                        ...
                        <div class="widget-content widget-content-area table-responsive">
                            <table id="style-3" class="table style-3  table-hover table-bordered table-striped table-checkable table-highlight-head mb-4">
                                ...
                                <tr>
                                    <th class="checkbox-column">
                                        <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                            <input type="checkbox" value="value1" name="name1" class="new-control-input todochkbox" id="todoAll">
                                ...
                                @foreach($roles as $role)
                                    <tr class="delete_row checkbox-column" id="row-{{$role->id}}">

                                        <td class="text-center " data-id="{{ $role->id }}">
                                            @if ($role->id != 1 )
                                            <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                <input type="checkbox" class="new-control-input todochkbox checkSingle"  id="{{ $role->id }}">
                                        ...
                                        <td class="text-center product-action">
                                            <ul class="table-controls">
                                                ...
                                                <li>
                                                    <a href="{{ route('admin.permissions.show', $role) }}"
                                                       title="عرض">
                                                        <i class="far fa-eye"></i><span class="icon-name"> </span>
                                                    </a>
                                                </li>

                                                <li>
                                                    <span class="delete-row bs-tooltip" data-url="{{ url('admin/permissions/' . $role->id) }}"
                                                          data-id="{{ $role->id }}">
