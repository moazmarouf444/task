    ...
    <!--  BEGIN CONTENT AREA  -->
        <div class="layout-px-spacing">
            ...
            <div class="seperator-header">
                <a  data-route="{{route('admin.admins.destroy_selected')}}" class="btn btn-danger mb-2 delete_all_button">
                    حذف المحدد
                        ...
                        <div class="widget-content widget-content-area table-responsive">
                            <table id="style-3" class="table style-3  table-hover table-bordered table-striped table-checkable table-highlight-head mb-4">
                                ...
                                @foreach ($admins as $admin)
                                    <tr class="delete_row checkbox-column" id="row-{{$admin->id}}">
                                        <td class="text-center " data-id="{{ $admin->id }}">
                                        @if ($admin->id != 1 && auth()->id() != $admin->id)
                                                <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                    <input type="checkbox" class="new-control-input todochkbox checkSingle"  id="{{ $admin->id }}">
                                        ...
                                        <td class="text-center">
                                            <span><img src="{{$admin->avatar}}" class="profile-img"
                                                       alt="avatar"></span>
                                        </td>
                                        <td>{{$admin->name}}</td>
                                        <td>{{$admin->phone}}</td>
                                        ...
                                        <td class="text-center product-action">
                                            <ul class="table-controls">
                                                ...
                                                @if ($admin->id != 1 && auth()->id() != $admin->id)
                                                    <li>
                                                        <span class="delete-row bs-tooltip" data-url="{{ url('admin/admins/' . $admin->id) }}"
                                                              data-id="{{ $admin->id }}">
