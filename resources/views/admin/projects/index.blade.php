    ...
    <!--  BEGIN CONTENT AREA  -->
        <div class="layout-px-spacing">
            ...
            <div class="seperator-header">
                <a  data-route="{{route('admin.projects.destroy_selected')}}" class="btn btn-danger mb-2 delete_all_button">
                    حذف المحدد
                        ...
                        <div class="widget-content widget-content-area table-responsive">
                            <table id="style-3" class="table style-3  table-hover table-bordered table-striped table-checkable table-highlight-head mb-4">
                                ...
                                @foreach ($projects as $project)
                                    <tr class="delete_row checkbox-column" id="row-{{$project->id}}">
                                        <td class="text-center " data-id="{{ $project->id }}">
                                                <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                    <input type="checkbox" class="new-control-input todochkbox checkSingle"  id="{{ $project->id }}">
                                        ...
                                        <td class="text-center"><span
                                            @if ($project->status == 'open')
                                                <span class="shadow-none badge badge-primary">مفتوح</span>
                                            @else
                                                <span class="shadow-none badge badge-danger">مغلق</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center product-action">
                                            <ul class="table-controls">
                                                ...
                                                <li>
                                                    ...
                                                    <li>
                                                        <span class="delete-row bs-tooltip" data-url="{{ url('admin/projects/' . $project->id) }}"
                                                              data-id="{{ $project->id }}">
