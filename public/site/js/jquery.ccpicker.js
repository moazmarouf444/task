...
$.extend(CcPicker.prototype, {
  init: function () {
    ...
    this._ccPicker = $('<div class="cc-picker cc-picker-code-select-enabled col-3">').insertAfter(this.element);
...
$("body").on("click", function () {
  ...
  if (e.options.countryFilter) {
      e._filter = $("<input/>", {"class": "cc-picker-code-filter", "placeholder": e.options.searchPlaceHolder}).insertAfter(e._list);
      e._filter.css({
